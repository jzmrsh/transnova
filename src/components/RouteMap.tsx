...
const RouteMap = () => (
  <section className="py-20 md:py-28 px-1">
    <div className="container mx-auto">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-3 opacity-0 animate-fade-up">Mapa de Rotas</h2>
      ...
      <div
        className="relative w-full aspect-[1/1] md:aspect-[16/9] max-w-4xl mx-auto rounded-xl bg-muted/60 border border-border/50 shadow-xl overflow-hidden opacity-0 animate-fade-up"
      ...
      >
        ...
        <iframe
          ...
          src="https://www.google.com/maps/d/embed?mid=1wUS5JwWjuDE8lDbB-cZFppGAP9r0jLo&ehbc=2E312F"
          width="640"
          height="480"
        ></iframe>
        ...
        {/* Dot markers */}
        {/*points.map((p) => (
          <div key={p.name} className="absolute group" style={{ left: p.x, top: p.y, transform: "translate(-50%, -50%)" }}>
